...
export async function GenerateDestinasibyAI(_prevState, formData) {
      ...
      messages: [
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              text: `carikan destinasi wisata di kota, pulau, kabupaten atau provinci ${city}`,
            },
          ],
        },
      ],
